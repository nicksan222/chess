...
`hardware/pcb/design/bom.md` is generated from the approved exact-MPN catalog and
reviewed netlist. The Raspberry Pi Zero 2 W, SK9822 architecture, four MCP23017s,
...
2. Confirm +3.3 V is absent until the Pi is installed; it is supplied by the Pi
   header.
3. Power down, install the Pi, then verify MCP23017 addresses 0x20-0x23 and the
   display at 0x3C.
4. Probe buffered LED clock/data and verify all 64 active-low Hall outputs with a
   magnet before mechanical assembly.
