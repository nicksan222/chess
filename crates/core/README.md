...
workspace, including collections and byte-oriented persistence capabilities.
Additions must have a concrete consumer, documented invariants, and no
dependency on hardware or application adapters.
