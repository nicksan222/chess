...
This map is for maintainers. How an application holds a `Game` and maps
players onto `White` / `Black` lives in [`DESIGN.md`](../DESIGN.md). The public
API is the crate root; these directories are private.
