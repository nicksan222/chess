...
from core.connectivity import ConnectionGraph, EndpointKey
from footprints import base as footprint_base
...
class KiCadBoard:
    ...
    def __init__(self, connections: ConnectionGraph) -> None:
        pcbnew.KIID.SeedGenerator(0x43484553)
        self.native = pcbnew.BOARD()
        self.connections = connections
        self.nets = self._add_nets(connections.names)
    ...
    def attach_component(self, item, entry: Mapping[str, object]) -> None:
        """Attach one placed product, its package, pads, and assigned native nets."""
