...
BOARD_PROJECT_PATH = GENERATED / "board-skeleton.blend"
TILE_TOP_PATH = GENERATED / "single-tile-top.blend"
TILE_BOTTOM_PATH = GENERATED / "single-tile-bottom.blend"
...
def render_views(
    ...
    scene.render.filepath = str(GENERATED / f"{NAME}-loading.png")
...
def build() -> None:
    ...
    scene["board_source"] = str(BOARD_PROJECT_PATH.relative_to(CAD_ROOT))
    scene["tile_top_source"] = str(TILE_TOP_PATH.relative_to(CAD_ROOT))
    scene["tile_bottom_source"] = str(TILE_BOTTOM_PATH.relative_to(CAD_ROOT))
