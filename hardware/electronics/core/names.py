"""Board coordinates, net names, and how the Pi is wired to everything.

This module owns every assignment decision. The component modules describe what
a part physically is; this decides which square lands on which expander pin and
which Broadcom line reads which button, so there is one place to look when the
schematic and the Rust host have to agree.
"""
